...
if imageStores != False:
    ...
    # here we need to manage the points so we chuck away the coords with a high y.
    f.soupedUpPlaneFitting(points)
    # then here we compute ransac which will give us the coordinates for
    # our plane.
